...
public class RedisCacheConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        // Use a dedicated ObjectMapper inside this bean for Redis serialization only.
        // Do NOT expose it as a Spring bean to avoid affecting HTTP JSON serialization.
